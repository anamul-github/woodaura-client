...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-green-100">
            ...
            {/* <div className="hidden lg:block w-8/10 h-0.5 bg-green-400 md:my-8"></div> */}
            <div className="py-6 text-sm text-center">©Woodaura Company Co. All rights reserved.</div>
        </footer>
    );
};
